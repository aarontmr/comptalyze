...
import { Store, Check, ArrowRight, Sparkles, Shield, FileText, BarChart3, Zap, Calendar, ClipboardList, Users, TrendingUp } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Créez des devis professionnels en quelques clics. Transformez-les en factures automatiquement une fois acceptés.",
      color: "#2E6CF6"
    },
    {
      icon: Calendar,
      title: "Planning et rendez-vous",
      description: "Organisez vos interventions et suivez vos rendez-vous. Gérez votre planning directement depuis l'application.",
      color: "#00D084"
    },
    {
      icon: Users,
      title: "Gestion clientèle",
      description: "Base de données clients complète avec historique des prestations. Suivez vos meilleurs clients et leurs besoins.",
      color: "#8B5CF6"
    },
    {
      icon: FileText,
      title: "Factures conformes",
      description: "Générez des factures conformes à la législation française. Toutes les mentions obligatoires incluses automatiquement.",
      color: "#f59e0b"
    },
    {
      icon: BarChart3,
      title: "Suivi d'activité",
      description: "Analysez vos prestations par type de service, client ou période. Identifiez vos services les plus rentables.",
      color: "#2E6CF6"
    },
    {
      icon: TrendingUp,
      title: "Optimisation fiscale",
      description: "ComptaBot IA vous conseille sur vos charges déductibles. Optimisez vos impôts légalement avec nos recommandations.",
      color: "#00D084"
    }
  ];
      ...
      <section className="relative px-4 pt-32 pb-16 sm:pt-40 sm:pb-20 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            ...
            style={{ background: "radial-gradient(closest-side, #8B5CF6, rgba(0,0,0,0))" }}
          />
        </div>
        ...
        <div className="mx-auto max-w-6xl text-center relative z-10">
          ...
          >
            <Store className="w-4 h-4" style={{ color: "#8B5CF6" }} />
            <span className="text-xs sm:text-sm font-medium text-gray-300">
              Solution comptable pour prestations de services
            </span>
          </div>

          <h1 className="text-4xl font-bold sm:text-5xl md:text-6xl lg:text-7xl leading-tight px-2 mb-6">
            <span className="block mb-2">Gérez vos prestations</span>
            <span 
            ...
            >
              de services sans complexité
            </span>
          </h1>

          <p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-8">
            <strong className="text-white">Devis, factures, planning, clients</strong> : une solution complète 
            pour gérer votre activité de services en micro-entreprise.
          </p>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
              Fonctionnalités adaptées aux services
            </h2>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              Tout ce dont vous avez besoin pour gérer efficacement votre activité de services
            </p>
          </div>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">
              Simplifiez la gestion de vos services
            </h2>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              Rejoignez des centaines de professionnels des services qui font confiance à Comptalyze
            </p>
            <Link
              href="/signup"
