...
/**
 * Composant client pour le compte à rebours du trial
 * (séparé pour permettre les animations et le timer)
 */
...
interface TrialBadgeClientProps {
  trialEndsAt: string;
  plan: 'pro' | 'premium';
  planColor: string;
  planGradient: string;
...
export default function TrialBadgeClient({ 
  trialEndsAt, 
  plan,
  planColor,
  planGradient 
}: TrialBadgeClientProps) {
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mb-4">
                ...
                >
                  <motion.div
                    initial={{ width: 0 }}
                    animate={{ width: `${Math.min(100, (totalDays / 3) * 100)}%` }}
              ...
              <p className="text-xs sm:text-sm text-gray-300 mb-3">
                Profitez de toutes les fonctionnalités {isPremium ? 'Premium' : 'Pro'} gratuitement :
              </p>
