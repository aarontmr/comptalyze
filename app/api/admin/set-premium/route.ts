  ...
  try {
    ...
    return NextResponse.json({
      ...
      instructions: [
        ...
        'Reconnectez-vous',
        'Les fonctionnalités Premium devraient maintenant être visibles',
      ],
    });
  } catch (error: any) {
